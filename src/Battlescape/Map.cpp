...
void Map::draw()
{
	...
	if ((_save->getSelectedUnit() && _save->getSelectedUnit()->getVisible()) || _unitDying || (_save->getSide() == FACTION_PLAYER && _save->getSelectedUnit() == 0) || _save->getDebugMode() || _projectileInFOV || _explosionInFOV)
	{
		drawTerrain(this);
	}
	else
