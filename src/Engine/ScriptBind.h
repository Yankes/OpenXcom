...
struct Bind : BindBase
{
	...
	template<auto MemPtr0>
	void addField(const std::string& get)
	{
		addCustomFunc<helper::BindPropGet<T, MACRO_CLANG_AUTO_HACK(MemPtr0)>>(getName(get), "Get field of " + prefix);
	}
	...
	{
		addCustomFunc<helper::BindPropGet<T, MACRO_CLANG_AUTO_HACK(MemPtr0)>>(getName(get), "Get field of " + prefix);
		addCustomFunc<helper::BindPropSet<T, MACRO_CLANG_AUTO_HACK(MemPtr0)>>(getName(set), "Set field of " + prefix);
	}
...
struct BindValue : BindBase
{
	...
	void addField(const std::string& get)
	{
		addCustomFunc<helper::BindValuePropGet<T, MACRO_CLANG_AUTO_HACK(MemPtr0)>>(getName(get), "Get field of " + prefix);
	}
	...
	{
		addCustomFunc<helper::BindValuePropGet<T, MACRO_CLANG_AUTO_HACK(MemPtr0)>>(getName(get), "Get field of " + prefix);
		addCustomFunc<helper::BindValuePropSet<T, MACRO_CLANG_AUTO_HACK(MemPtr0)>>(getName(set), "Set field of " + prefix);
	}

	template<auto MemPtr0, auto MemPtr1, auto... MemPtrR>
	void addField(const std::string& get)
	{
		addCustomFunc<helper::BindValuePropGet<T, MACRO_CLANG_AUTO_HACK(MemPtr0), MACRO_CLANG_AUTO_HACK(MemPtr1), MACRO_CLANG_AUTO_HACK(MemPtrR)...>>(getName(get), "Get inner field of " + prefix);
	}
	template<auto MemPtr0, auto MemPtr1, auto... MemPtrR>
	void addField(const std::string& get, const std::string& set)
	{
		addCustomFunc<helper::BindValuePropGet<T, MACRO_CLANG_AUTO_HACK(MemPtr0), MACRO_CLANG_AUTO_HACK(MemPtr1), MACRO_CLANG_AUTO_HACK(MemPtrR)...>>(getName(get), "Get inner field of " + prefix);
		addCustomFunc<helper::BindValuePropSet<T, MACRO_CLANG_AUTO_HACK(MemPtr0), MACRO_CLANG_AUTO_HACK(MemPtr1), MACRO_CLANG_AUTO_HACK(MemPtrR)...>>(getName(set), "Set inner field of " + prefix);
	}
